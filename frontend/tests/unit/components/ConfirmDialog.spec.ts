...
describe("ConfirmDialog", () => {
  it("renders title and description", () => {
    const wrapper = mount(ConfirmDialog, {
      props: { open: true, title: "Delete?", description: "Are you sure?" },
      global: { stubs },
    });
  ...
  it("emits confirm on confirm button click", async () => {
    const wrapper = mount(ConfirmDialog, {
      props: { open: true, title: "Delete?", description: "Sure?" },
      global: { stubs },
    });
  ...
  it("shows pending state on confirm button", () => {
    const wrapper = mount(ConfirmDialog, {
      props: { open: true, title: "Delete?", description: "Sure?", pending: true },
      global: { stubs },
    });
